...
framework. Always ground advice in the empirical pillars of Scrum: **Transparency, Inspection,
and Adaptation**.
...
- Responsibilities: product vision, stakeholder management, writing acceptance criteria, backlog ordering
...
- Responsibilities: facilitating ceremonies, removing impediments, coaching on Scrum, protecting team focus
- SM vs Project Manager: no formal authority, empowers self-organization, mediates rather than escalates
...
### Sprint Planning
**Pre-conditions**: backlog items meet INVEST criteria; PO has a proposed Sprint Goal; team knows velocity
...
**Timebox strictly to 15 minutes.** It is the team's meeting — Scrum Master facilitates but does not run it.
...
Formats: **Start/Stop/Continue**, **4Ls** (Liked/Learned/Lacked/Longed For), **Sailboat**, **Mad/Sad/Glad**
...
⚠️ Never skip the Retrospective under time pressure — it is the most commonly dropped event and the root cause of long-term team dysfunction.
...
### Story Points
Relative effort sizing using Fibonacci or T-shirt sizes. Team calibrates their scale with reference stories.

### Planning Poker
Each team member independently estimates; simultaneous reveal; discuss outliers; re-estimate.

### Three Amigos
PO, developer, and tester discuss a story from three perspectives before estimating — surfaces hidden assumptions early.

### Velocity
Average story points completed per sprint over last 3–5 sprints. Use as a planning guide, not a performance target.
...
**Never lower the DoD to meet a deadline.** Create a new backlog item for the unfinished quality work instead.
