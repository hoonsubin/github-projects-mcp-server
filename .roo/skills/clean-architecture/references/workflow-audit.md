...
- **Python Ecosystem**
  - Tools: `pydeps`, `pyan`
- **Java Ecosystem**
  - Tools: `jdepend`, `jqassistant`, ArchUnit
- **C#/.NET Ecosystem**
  - Tools: `NDepend`, `dotnet-grapher`
- **Go Ecosystem**
  - Tools: `go mod graph`, `godepgraph`
- **Rust Ecosystem**
  - Tools: `cargo-modules`, `cargo-deps`
...
Does the project root scream the _business domain_ (`customers/`, `orders/`) or the _framework_ (`controllers/`, `models/`, `views/` as root siblings)? Framework-screaming = finding.
