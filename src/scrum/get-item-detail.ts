// =============================================================================
// src/scrum/get-item-detail.ts - getItemDetailUseCase
//
...
import { parseAcceptanceCriteria } from "./utils/acceptance-criteria.ts";
 ...
 */
export const getItemDetailUseCase = async (
  backend: StoryPort,
  ref: StoryRef,
