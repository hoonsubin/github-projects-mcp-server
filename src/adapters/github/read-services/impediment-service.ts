// =============================================================================
// src/adapters/github/impediment-service.ts - Impediment Operations
//
...
import { resolveSprint, resolveStory } from "../infra/resolver.ts";
import { BoardScanCoordinator } from "./board-scan-coordinator.ts";

/** Injected at wiring time from write-services — not imported to preserve folder boundary. */
interface ImpedimentStoryMutations {
  createStory(input: CreateStoryInput): Promise<StoryRef>;
}

/** Injected at wiring time from write-services — not imported to preserve folder boundary. */
interface ImpedimentLabelResolution {
  resolveOrCreateLabel(name: string): Promise<string | null>;
}
...
export class ImpedimentService {
  constructor(
    ...
    private readonly labelResolver: ImpedimentLabelResolution,
    private readonly storyMutationService: ImpedimentStoryMutations,
