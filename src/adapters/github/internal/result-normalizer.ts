 ...
 *
 * Phase 4: created as infrastructure. Assemblers currently delegate to
 * StoryQueryService directly; the normalizer provides the standalone
 * mapping capability for future wiring into the assembler pipeline.
 */
